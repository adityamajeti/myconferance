module Portal
  class ConferenceRoomsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @conference_room.save
          format.html { redirect_to portal_conference_room_url(@conference_room), notice: 'Conference room was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @conference_room.update(conference_room_params)
          format.html { redirect_to portal_conference_room_url(@conference_room), notice: 'Conference room was successfully updated.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to portal_conference_rooms_url, notice: 'Conference room was successfully destroyed.' }
